    ...
    >
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '10rem', alignItems: 'start' }} className="responsive-split">
          <div>
            <p className="section-tag" style={{ color: 'var(--sage)', marginBottom: '0.75rem' }}>Basket 09 — Dexamethasone</p>
            <h2 style={{ fontFamily: 'var(--font-cormorant)', fontSize: 'clamp(1.8rem, 3vw, 2.5rem)', fontWeight: 300, color: 'var(--cream)', lineHeight: 1.2, margin: '0 0 1.25rem' }}>
              High-Purity<br />
              <span style={{ fontStyle: 'italic', color: 'var(--sage)' }}>Dexamethasone Basket</span>
            </h2>
            <p style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '0.85rem', fontWeight: 300, color: 'rgba(248,246,241,0.6)', lineHeight: 1.75, margin: 0 }}>
              Steroid basket for anti-inflammatory and immunosuppressant product opportunities.
            </p>
          </div>
          <div>
            <p className="section-tag" style={{ color: 'var(--sage)', marginBottom: '1rem' }}>Portfolio Products</p>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
              {['Dexamethasone Base', 'Dexamethasone Sodium Phosphate'].map((p) => (
                <span
                  key={p}
                  style={{
